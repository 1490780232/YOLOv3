...
namesfile=None
def detect(cfgfile, weightfile, imgfile, save_path):
    m = Darknet(cfgfile)
...
def detect_cv2(cfgfile, weightfile, imgfile, save_path):
    import cv2
    m = Darknet(cfgfile)
...
def detect_skimage(cfgfile, weightfile, imgfile, save_path):
...
if __name__ == '__main__':
    if len(sys.argv) == 5:
        ...
        detect_cv2('cfg/yolo_v3.cfg', 'save_weights\\000160.weights', imgfile='data\VOCdevkit\VOC2021\JPEGImages\\11.bmp', save_path='./prediction.jpg') #, version=1