...
if __name__ == '__main__':
    ...
    parser.add_argument('--data', '-d',    type=str, 
        default='cfg/voc.data', help='data definition file')
    parser.add_argument('--config', '-c',  type=str, 
        default='cfg/yolo_v3.cfg', help='network configuration file')
    parser.add_argument('--weights', '-w', type=str, nargs='+', 
        default=['save_weights/000160.weights'], help='initial weights file')
